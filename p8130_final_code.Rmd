...
reg_crimes = 
  lm(hate_crimes_per_100k_splc ~ factor(unemployment) + factor(urbanization) + median_household_income +  perc_non_citizen + gini_index, data = crime_df)
...
reduced_model = lm(hate_crimes_per_100k_splc ~ factor(unemployment) + factor(urbanization) + median_household_income +  perc_non_citizen, data = crime_df)
